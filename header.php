		...
		<div class="top-area">
			...
			<br>
				...
				<div class="user-setting">
					<a href="logout.php" title=""><i class="ti-power-off"></i>logout</a>
			...
			?>
			<a href="profile.php" ><i class="ti-user"> </i><?PHP echo $row1['name'];  ?></a>
			&nbsp;&nbsp;&nbsp;
			<a href="logout.php"><i class="ti-power-off"> Logout</i></a>
		</div>
	</div><!-- topbar -->
